...
namespace Extension\utilisateurs;
 ...
 * @author oliver
 */
class OpenId extends \Exception{
	...
	public function formulaireLogin(){
		$p = '
			<fieldset id="openid">
				...
				<form action="index.php" method="post" onsubmit="this.login.disabled=true;">
					<input type="hidden" name="openid_action" value="login">
					<div>
						<input type="text" name="openid_url" class="openid_login"><input type="submit" name="login" value="login &gt;&gt;">
					</div>
					<div>
						<a href="http://www.myopenid.com/" class="link" >Get an OpenID</a>
					</div>
				</form>
			</fieldset>';
		return $p;
